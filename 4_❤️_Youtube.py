...
st.title("❤️ Melomind-Youtube")
st.markdown(''':red[**Note : It is recommended that you scan your face , for Melomind to groove with you!**]''')
   ...
   if english:
        if st.session_state["emotion"] == "Happy":
           ...
           st_player("https://www.youtube.com/watch?v=BwleOnML1Fo")
            ...
            st_player("https://youtu.be/AB_Vn8W8vMc?si=nOQdXmxJ1SPSTEgt")
        elif st.session_state["emotion"] == "Surprise":
